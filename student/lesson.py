...
def reset():
    ...
    lesson_list[1][1][1][1].append(['教材：坦克大戰', "2_5.zip", 5, 292002495, False, False])          
    lesson_list[1][1][1][1].append(['習作：星際爭霸', "2_6.zip", 6, 292003017, False, False])                     
    lesson_list[1][1].append(['分身篇', []])
    lesson_list[1][1][2][1].append(['教材：螞蟻覓食', "2_7.zip", 7, 292004483, False, False])       
    ...
    lesson_list[1][1][5][1].append(['教材：跨欄比賽', False, 15, 375512447, False, False])  
    lesson_list[1][1][5][1].append(['教材：后羿射日', False, 16, 376829157, False, False])   
    lesson_list[1][1][5][1].append(['教材：蒙地卡羅法', False, 17, 359010095, False, False])   
reset()
